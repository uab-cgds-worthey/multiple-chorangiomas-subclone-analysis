...
```{r}
library(clonevol)
# df <- read.table(file = "data/clonevol-input/pvp-binomial_clonal-clonevol.tsv", header = TRUE, sep = "\t")
# df <- read.table(file = "data/30depth-5vaf-clonevol-input/pvp-binomial_clonal-clonevol.tsv", header = TRUE, sep = "\t")
# df <- read.table(file = "data/30depth-5vaf-clonevol-input/pvp-beta_binomial_clonal-clonevol.tsv", header = TRUE, sep = "\t")
df <- read.table(file = "data/40depth-10vaf-clonevol-input/pvp-binomial_clonal-clonevol.tsv", header = TRUE, sep = "\t")
```
...
y <- infer.clonal.models(
  ...
  cluster.col.name = "cluster",
  vaf.col.names = grep("_vaf", colnames(df), value = TRUE),
  # ccf.col.names = grep("_ccf", colnames(df), value = TRUE),
...
plot.clonal.models(
  ...
  out.dir = "data/40depth-10vaf-clonevol-output",
  out.format = "pdf",
