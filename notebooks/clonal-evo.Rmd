...
```{r}
library(clonevol)
df <- read.table(file = "data/incvar-40depth-20vaf-clonevol-input/pvp-beta_binomial_clonal-clonevol.tsv", header = TRUE, sep = "\t")
```
...
plot.clonal.models(
  ...
  out.dir = "data/incvar-40depth-20vaf-clonevol-output",
  out.format = "pdf",
